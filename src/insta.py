...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Properties window
        self.setWindowTitle('Insta - Instagram Desktop')
...
class Browser(QWebEngineView):
    ...
    def contextMenuEvent(self, event):
        ...
        if capture_url:  # Menu for link mouse hover
            ...
            self.menu.addAction(self.main.view.pageAction(QWebEnginePage.Back))
            self.menu.addAction(self.main.view.pageAction(QWebEnginePage.Forward))
...
if __name__ == '__main__':
    if j.set_json('DarkMode') == 'True':
        arg = argv + ["--blink-settings=forceDarkModeEnabled=true"]
    else:
        arg = []
    whats = QApplication(argv + arg)
