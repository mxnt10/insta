...
orig = '/usr/share/applications/insta.desktop'
dest = expanduser('~/.config/autostart')
desk = dest + '/insta.desktop'


# Define application icon
def set_icon(entry_icon=None):
    icon = '/usr/share/pixmaps/insta.png'
    l_icon = '../appdata/insta.png'

    if entry_icon is not None:
        icon = '/usr/share/insta/icon_status/' + entry_icon + '.png'
